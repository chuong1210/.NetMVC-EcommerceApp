...
namespace DoAnLapTrinhWeb.Controllers
{
    ...
    {
        private readonly ShopApp2024Context _context;

        public HangHoasController(ShopApp2024Context context)
        {
            _context = context;
        }
        ...
        {
            var shopApp2024Context = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await shopApp2024Context.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ShopApp2024Context.HangHoas'  is null.");
            }
            var hangHoa = await _context.HangHoas.FindAsync(id);
            if (hangHoa != null)
            {
